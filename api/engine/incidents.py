...
class IncidentRecord:
    ...
    # When an alert for this incident actually landed, and who raised it. The agent is the
    # normal path; the runtime only steps in when there was no agent answer at all.
